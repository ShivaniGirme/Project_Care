...
<body class="homepage">
					...
					<div class="offcanvas offcanvas-end" tabindex="-1"
						...
						<div class="offcanvas-body">
							<ul
								...
								<li class="nav-item"><a class="nav-link"
									href="ownerAllStock.jsp">Stock</a></li>
								<li class="nav-item dropdown"><a
									...
									<ul class="dropdown-menu list-unstyled"
										...
										<li><a href="ownerOrders.jsp" class="dropdown-item item-anchor">Total
												order</a></li>
										<li><a href="ownerPastOrders.jsp" class="dropdown-item item-anchor">Past
												Orders</a></li>
									</ul></li>
								...
								<li class="nav-item dropdown"><a
									...
									<ul class="dropdown-menu list-unstyled"
										...
										<li><a href="addStudio.jsp" class="dropdown-item item-anchor">Add
												Studio</a></li>
										<li><a href="ownerStudio.jsp" class="dropdown-item item-anchor">Edit
												Studio</a></li>
									</ul></li>
								...
								<li class="nav-item dropdown"><a
									...
									<ul class="dropdown-menu list-unstyled"
										aria-labelledby="dropdownBlog">
										<li><a href="addArtist.jsp" class="dropdown-item item-anchor">Add
												Makeup Artist</a></li>
										<li><a href="ownerArtist.jsp" class="dropdown-item item-anchor">Edit
												Makeup Artist</a></li>
									</ul></li>
	...
	<div style="display: flex;">
		<div class="container1">
			...
			%>
			<form id="labForm" action="addStudio" method="POST">
				<div class="user-details">

					<div class="input-box">
						<span class="details">Studio Name</span> <input type="text"
							placeholder="Lab Name" id="labName" name="name" required>
					</div>

					<div class="input-box">
						<span class="details">Studio Contact</span> <input type="text"
							placeholder="Lab Contact" id="labContact" name="contact" required
							pattern="[6-9]{1}[0-9]{9}">
					</div>

					<div class="input-box">
						<span class="details">Studio Location</span> <input type="text"
							placeholder="Lab Location" id="labLocation" name="location"
							required>
					</div>

					<div class="input-box" style="margin-left: 40px;">
						<span class="details">Fees</span> <input type="text"
							placeholder="Fees" id="labFees" name="fees" required>
					</div>
		...
		<div style="margin-top: 40px; margin-left: 100px">
			<img alt="studio"
				src="https://media.istockphoto.com/id/1153274585/photo/makeup-school.jpg?s=612x612&w=0&k=20&c=iyJUmHY94i3fGQXBYaE3GzoPjAsRyngeBfRXaaqpY6I=">
