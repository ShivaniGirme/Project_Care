...
<%
		...
		<div class="container">
			...
			List<Product> alist = product1.getAllProductById(user.getUserId());
			%>
			...
			<thead>
				...
				<tr>
					...
					<td><%=product.getMgfDate()%></td>
					<td><%=product.getCategory()%></td>
					<td><a href="updateproduct?id=<%=product.getProductId()%>"><button>Update</button></a></td>
					<td><a href="delete?id=<%=product.getProductId()%>"><button>Delete</button></a></td>
