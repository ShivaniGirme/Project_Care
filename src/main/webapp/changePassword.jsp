        ...
        <div class="wrapper">
            <div class="inner">
                <div class="image-holder">
                    <img src="https://img.freepik.com/premium-photo/light-natural-cosmetics-cream-peach-background-spa-products-flatlay_124507-34050.jpg" alt="">
                </div>
                <form action="updatepassword">
                    ...
                    <div class="form-holder">
                        <input class="form-control"  type="password" name="confirmpassword" placeholder="Confirm the Password" required>
                    </div>
