        ...
        <div class="wrapper">
            <div class="inner">
                <div class="image-holder">
                    <img src="https://cdni.iconscout.com/illustration/premium/thumb/password-recovery-9065842-7343064.png?f=webp" alt="">
                </div>
                <form action="updatepassword">
                    ...
                    <div class="form-holder">
                        <input type="text" name="email" class="form-control" value="<%=user.getEmail() %>" readonly="readonly">
                    </div>

                    <div class="form-holder">
                        <input class="form-control"  type="text" name="password" placeholder="Enter Your New Password" required>
                    </div>


                    <div class="form-holder">
                        <input class="form-control"  type="text" name="confirmpassword" placeholder="Confirm the Password" required>
                    </div>
                    ...
                    <div class="form-login">
                       <button class="button">UPDATE</button>
                         <a href="buyerHomePage.jsp"><input class="button" type="button"
                value="Cancel"></a>
                    </div>
                </form>
            </div>
