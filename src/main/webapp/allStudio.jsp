...
<%@page import="care.dao.StudioCRUD"%>
...
<%	
	...
	List<Studio> list =crud.getAllStudio() ;
...
%>
  ...
  <div class="mg">
    <div class="clr"></div>
    <div class="group">
      <span><%=studio.getName() %></span>
    </div>
  </div>
  
  
  
  <%if(studio.getStudioId()%2==0) {%>
  <div class="av" style="background-image: url('https://media.istockphoto.com/id/1180489469/photo/girl-applying-red-lipstick-on-her-lips.jpg?s=612x612&w=0&k=20&c=HREr1V8epyTbSaf3RJBjoKfyAUDQDjWaIyD8eiKPpws=');"></div>
  <%}else{ %>
    <div class="av" style="background-image: url('https://media.istockphoto.com/id/985255426/photo/kseniya.jpg?s=612x612&w=0&k=20&c=2sg-vtK-W6kXORT7L1OM2HY3rzD6zbFFVfwi4tKfz10=');"></div>
  <%} %>
  <div class="info">
    
    <feet>
     Contact:<%=studio.getContact() %><br>
     Fees:<%=studio.getFees() %><br>
     Location:<%=studio.getLocation() %>
    </feet>
  </div>
  <a class="plot" onclick="display()">
    Book Appointment
  </a>
</div>
  <%
