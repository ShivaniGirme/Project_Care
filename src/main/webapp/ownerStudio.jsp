...
<%
    ...
    <table class="table table-hover">
		<thead>
			...
			List<Studio> list = crud.getStudioByUserId(user.getUserId());
			Collections.reverse(list);
			for (Studio studio : list) {
			%>
			
			<tr>
					<td scope="row"><%=studio.getStudioId()%></td>
					<td><%=studio.getName()%></td>
					<td><%=studio.getFees()%></td>
					<td><%=studio.getLocation()%></td>
					<td><%=studio.getContact()%></td>
					<td><a href="updateStudio?studioId=<%=studio.getStudioId()%>"><button>Update</button></a></td>
					<td><a href="deleteStudio?studioId=<%=studio.getStudioId()%>"><button>Delete</button></a></td>
