...
<html>
<head>
<title>OwnerProductUpdate</title>
<meta charset="utf-8">
...
<body class="homepage">
						...
						<div class="offcanvas-body">
							<ul
								...
								<li class="nav-item"><a class="nav-link"
									href="ownerHomePage.jsp">Home</a></li>
								<li class="nav-item"><a class="nav-link" href="ownerAllStock.jsp">Stock</a>
								</li>
								<li class="nav-item dropdown"><a
									...
									<ul class="dropdown-menu list-unstyled"
										...
										<li><a href="addProduct.jsp"
											class="dropdown-item item-anchor">Add Product</a></li>
										<li><a href="ownerProductFunctionality.jsp"
											class="dropdown-item item-anchor">Edit Product</a></li>
										<li><a href="#" class="dropdown-item item-anchor">Total
												order</a></li>
										<li><a href="#" class="dropdown-item item-anchor">Past
												Orders</a></li>
									</ul></li>
								...
								<li class="nav-item dropdown"><a
									...
									<ul class="dropdown-menu list-unstyled"
										...
										<li><a href="#" class="dropdown-item item-anchor">Add
												Studio</a></li>
										<li><a href="#" class="dropdown-item item-anchor">Edit
												Studio</a></li>
									</ul></li>
								...
								<li class="nav-item dropdown"><a
									class="nav-link dropdown-toggle" href="#" id="dropdownBlog"
									data-bs-toggle="dropdown" aria-haspopup="true"
									aria-expanded="false">Makeup Artist</a>
									<ul class="dropdown-menu list-unstyled"
										aria-labelledby="dropdownBlog">
										<li><a href="#" class="dropdown-item item-anchor">Add
												Makeup Artist</a></li>
								...
								<li class="nav-item dropdown"><a
									...
									<ul class="dropdown-menu list-unstyled"
										...
										<li><a href="ownerProfile.jsp"
											class="dropdown-item item-anchor">Your Profile </a></li>
										<li><a href="ownerChangePassword.jsp"
	...
	<div style="display: flex;">
				...
				<div class="user-details">
					<div class="input-box" style="width: 500px;">
						<span class="details">Product Name</span> <input type="text"
							name="name" placeholder="name" value="<%=product.getName()%>"
							required>
					</div>
					...
					<div style="display: flex; width: 500px;">
						<div class="input-box" style="width: 250px;">
							<span class="details">Mfg Date</span> <input type="date"
								placeholder="Mfg_Date" required name="mfg"
								value="<%=product.getMgfDate()%>">
						</div>
						<div class="input-box" style="margin-left: 20px; width: 250px;">
							<span class="details">Exp Date</span> <input type="date"
								placeholder="Exp_Date" id="expDate" required name="exp"
								value="<%=product.getExpDate()%>">
						</div>

					</div>
					<div class="input-box" style="width: 500px;">
						<span class="details">Price</span> <input type="text" name="price"
							value="<%=product.getPrice()%>" required placeholder="Price">
					</div>
					...
					<div>
						...
						<div>
							...
							<label class="rdobtn">Skin care</label> <input type="radio"
								name="productType" value="Makeupproducts" required> <label
								class="rdobtn">Make-Up Products</label> <input type="radio"
								name="productType" value="Beautyproducts" required> <label
								class="rdobtn">Beauty Products</label>
						</div>
					</div>

					<input id="userId" name="uid" value="<%=user.getUserId()%>" hidden>
				</div>
		...
		<div>
			<img alt="myProduct"
				src="https://blogscdn.thehut.net/app/uploads/sites/480/2020/11/glossybox-fenty-beauty-limited-edition-second-sneak-peek_1606304402.gif"
				class="image">
		</div>
	</div>
