...
<title>AllSkinCareProduct</title>
<meta charset="utf-8">
...
.product-col-left {
	background: linear-gradient(rgba(0, 0, 0, 0), rgba(0, 0, 0, 0.3)),
		url("images/fashion-img-1.jpg") center/cover no-repeat;
}

.product-col-r-top {
	background: linear-gradient(rgba(0, 0, 0, 0), rgba(0, 0, 0, 0.3)),
		url("images/fashion-img-2.png") center/cover no-repeat;
}
...
<body class="homepage">
  ...
  <%
	...
	List<Product> alist = product1.getSkinCareProduct();
				...
				<div class="product">
					...
					<div class="product-content">
						<div class="product-img">
							<img src="DisplayProduct?id=<%=product.getProductId()%>" width="200" height="180"
								alt="product image">
						</div>
						<div class="product-btns">
						 <a href="order?orderid=<%=product.getProductId()%>">
					...
					<div class="product-info">
						<div class="product-info-top">
							<h2 class="sm-title">Product</h2>
							<%
							if (product.getCategory().equalsIgnoreCase("skincare")) {
							%>
							<div class="rating">
						...
						<%if(product.getCategory().equalsIgnoreCase("Haircare")){ %>
						<p1 class="product-price1">Rs. <%=product.getPrice() * (1 + 0.25) %></p1>
						<p1 class="product-price2">Rs. <%=product.getPrice() %></p1>
					<%}else{ %>
