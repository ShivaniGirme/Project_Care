...
<%@page import="care.dao.ArtistCRUD"%>
...
.card-hover:hover .card-hover__content {
  ...
  padding-bottom: 40px;
  padding-top: 37px;
  transition: all 0.40s cubic-bezier(.1,.72,.4,.97);
...
<script>
	function display() {
		alert("Appointment has been taken. Congratulations!");
	}
</script>
...
<body class="homepage">
  ...
  <%
	...
	List<Artist> list = crud.getAllArtist();
   ...
   <div class="card-hover">
    <div class="card-hover__content">
      <h3 class="card-hover__title">
        Book your <span>Appointment</span> now!
      </h3>
      <p class="card-hover__text">
        Artist Name: <temp style="font-weight: normal;"><%=artist.getName()%></temp><br>
        Email: <temp style="font-weight:normal ;"><%=artist.getEmail()%></temp><br>
        Phone: <temp style="font-weight:normal ;"><%=artist.getPhone()%></temp><br>
        Specialization: <temp style="font-weight: normal;"><%=artist.getSpecialization() %></temp><br>
        Experience: <temp style="font-weight: normal;"><%=artist.getExperience()+" "%>years</temp><br>
        Fees: <temp style="font-weight: normal;">Rs.<%=artist.getFees()%></temp>
        
     </p>
      <ab  class="card-hover__link">
        <span class="button" onclick="display()">Book Now</span>
            
      </ab>
    </div>
    <div class="card-hover__extra">
      <h4>Book <span>now</span> and get <span>40%</span> discount!</h4>
    </div>
    <%if(artist.getArtistId()%2==0){ %>
    <img src="https://media.istockphoto.com/id/1315019440/photo/stunning-indian-bride-in-luxurious-bridal-costume-with-makeup-and-heavy-jewellery-is-sitting.jpg?s=612x612&w=0&k=20&c=1d52jZ_3yohhDma5lp9kqOEQQpvV4mbzYG5NyygMHvU=" alt="">
    <%}else{ %>
    <img src="https://media.istockphoto.com/id/805430678/photo/beautiful-brunette-girl-fashion-portrait-with-beauty-makeup-fashionable-luxury-golden-jewelry.jpg?s=612x612&w=0&k=20&c=nIspBtM_Xxi7Gjok15z09SEJh9mzQEoApO82g0xmGyQ=" alt="">
    <%} %>

  </div>
  <%
				count++;
				if (count % 4 == 0 && count < list.size()) {
				%>
			</div>
			<div class="row">
				<%
