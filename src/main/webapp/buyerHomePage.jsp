          ...
          <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar"
            ...
            <div class="offcanvas-body">
              <ul class="navbar-nav justify-content-end  flex-grow-1 gap-5 pe-3">
                 <li class="nav-item">
                  <a class="nav-link" href="buyerHomePage.jsp">Home</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="allProduct.jsp">Products</a>
                </li>
                <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu list-unstyled" aria-labelledby="dropdownShop">
                    <li>
                      <a href="SkinCareProducts.jsp" class="dropdown-item item-anchor">Skin care</a>
                    </li>
                    <li>
                      <a href="hairCareProduct.jsp" class="dropdown-item item-anchor">Hair Care</a>
                    </li>
                    <li>
                      <a href="beautyproducts.jsp" class="dropdown-item item-anchor">Beauty Products</a>
                    </li>
                  </ul>
                </li>
                <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu list-unstyled" aria-labelledby="dropdownBlog">
                    <li>
                      <a href="allStudio.jsp" class="dropdown-item item-anchor">Studio</a>
                    </li>
                    <li>
                      <a href="allArtist.jsp" class="dropdown-item item-anchor">Makeup Artist</a>
                    </li>
                  </ul>
                </li>
                <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu list-unstyled" aria-labelledby="dropdownPages">
                    <li>
                      <a href="profile.jsp" class="dropdown-item item-anchor">Your Profile </a>
                    </li>
                    <li>
                      <a href="buyerTotalOrder.jsp" class="dropdown-item item-anchor">Orders</a>
                    </li>
                    <li>
                      <a href="changePassword.jsp" class="dropdown-item item-anchor">Change Password</a>
                    </li>
                    <li>
        ...
        <div class="swiper-wrapper d-flex">
          ...
          <div class="swiper-slide">
            <div class="product-item ">
              <div class="image-holder position-relative">
                <a href="single-product.html">
                  <img src="images/product-item13.jpg" alt="categories" class="scale-up-ver-center product-image img-fluid ">
                </a>
                <a href="wishlist.html" class="btn-icon btn-wishlist ">
                  <svg width="24" height="24" viewBox="0 0 24 24" class="svg-color">
                    <use xlink:href="#heart"></use>
