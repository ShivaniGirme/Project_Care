...
<body class="homepage">
  ...
  <nav class="navbar navbar-expand-lg text-uppercase fs-6 py-3 px-0 px-md-3 border-bottom align-items-center">
   ...
   <div style="margin-top: 40px; margin-left: 100px">
		<img alt="studio"
			src="https://media.istockphoto.com/id/1131138750/photo/young-professional-make-up-artists-with-client-in-room-woman-on-left-hold-eyeshadows-palette.jpg?s=612x612&w=0&k=20&c=m_49FcjaoNaAKQF0P6ZlKUV9Ru4wS4TMib4EdFEaIoA=">
	...
	<div style="display: flex;">
        ...
        <form action="updateStudio" method="post">
        	<input type="hidden" name="studioId" value="<%=studio.getStudioId()%>" readonly>
            <div class="user-details">           
                <div class="input-box">
                    <span class="details">Name</span>
                    <input type="text" placeholder="Lab Name" id="name" name="name" value="<%=studio.getName()%>"  required>
                </div>
            
                <div class="input-box">
                    <span class="details"> Contact</span>
                    <input type="text" placeholder="Lab Contact" d="contact" name="contact" value="<%=studio.getContact() %>" required>
                </div>

                <div class="input-box">
                    <span class="details">Location</span>
                    <input type="text" placeholder="Lab Location" id="location" name="location" value="<%=studio.getLocation()%>" required>
                </div>

                 <div class="input-box" style="margin-left: 40px;">
                    <span class="details">Fees</span>
                    <input type="text" placeholder="Fees" id="fees" name="fees" value="<%=studio.getFees()%>" required>
                </div>
               <input type="hidden" name="userId" value="<%=studio.getUserID()%>" readonly> <br>
            </div>
           
           <div class="button" style="width: 600px;  ">
            <input type="submit" name="Register" value="Update" style="font-weight: bolder; letter-spacing: 3px;">
        </div> 
	</form>
	<% } %>
	</div>
