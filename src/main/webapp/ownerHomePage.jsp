...
<body class="homepage">
        ...
        <div class="swiper-wrapper d-flex">
            ...
            <div class="product-item ">
              <div class="image-holder position-relative">
                <a href="single-product.html">
                  <img src="images/product-item5.jpg" alt="categories" class="product-image img-fluid">
                </a>
          ...
          <div class="swiper-slide">
            <div class="product-item ">
              <div class="image-holder position-relative">
                <a href="single-product.html">
                  <img src="images/product-item13.jpg" alt="categories" class="product-image img-fluid">
                </a>
                <a href="wishlist.html" class="btn-icon btn-wishlist ">
                  <svg width="24" height="24" viewBox="0 0 24 24" class="svg-color">
                    <use xlink:href="#heart"></use>
          ...
          <div class="swiper-slide">
            <div class="product-item ">
              <div class="image-holder position-relative">
                <a href="single-product.html">
                  <img src="images/product-item8.jpg" alt="categories" class="product-image img-fluid">
                </a>
                <a href="wishlist.html" class="btn-icon btn-wishlist ">
                  <svg width="24" height="24" viewBox="0 0 24 24" class="svg-color">
                    <use xlink:href="#heart"></use>
  ...
  <section id="best-sellers" class="best-sellers product-carousel position-relative my-5 open-up"
    data-aos="zoom-out">
    <div class="container">
      <div class="d-flex flex-wrap justify-content-between align-items-center my-5 py-lg-5">
        <div class="line-img my-2">
        ...
        <div class="swiper-wrapper d-flex">
          <div class="swiper-slide">
            <div class="product-item ">
              <div class="image-holder position-relative">
                <a href="single-product.html">
                  <img src="images/product-item7.jpg" alt="categories" class="product-image img-fluid">
                </a>
                <a href="wishlist.html" class="btn-icon btn-wishlist ">
                  <svg width="24" height="24" viewBox="0 0 24 24" class="svg-color">
                    <use xlink:href="#heart"></use>
          ...
          <div class="swiper-slide">
            <div class="product-item ">
              <div class="image-holder position-relative">
                <a href="single-product.html">
                  <img src="images/product-item11.jpg" alt="categories" class="product-image img-fluid">
                </a>
                <a href="wishlist.html" class="btn-icon btn-wishlist ">
                  <svg width="24" height="24" viewBox="0 0 24 24" class="svg-color">
                    <use xlink:href="#heart"></use>
    ...
    <div class="row d-flex flex-wrap g-0">
      <div class="col-md-6 col-sm-6">
        <div class="cat-item position-relative">
          <div class="image-holder">
            <a href="shop.html"><img src="images/cat-large-item1.jpg" alt="categories"
            ...
            <div class="category-content position-absolute p-md-5 ps-5 p-3 text-uppercase  ">
              ...
              <div class="btn-left btn-swiper">
                <a href="shop.html" class="btn btn-light text-white bg-transparent text-uppercase">Shop Now</a>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="col-md-6 col-sm-6">
        <div class="">
          <div class="cat-item position-relative">
            <div class="image-holder">
              <a href="shop.html"><img src="images/cat-large-item2.jpg" alt="categories"
                  class="product-image img-fluid"></a>
              <div class="category-content position-absolute p-md-5 ps-5 p-3 text-uppercase">
                <h4 class="section-title text-white display-6">Hair Care</h4>
        ...
        <div class="">
          <div class="cat-item position-relative">
            <div class="image-holder">
              <a href="shop.html"><img src="images/cat-large-item3.jpg" alt="categories"
                  class="product-image img-fluid"></a>
              <div class="category-content position-absolute p-md-5 ps-5 p-3 text-uppercase">
  ...
  <section id="related-products" class="related-products product-carousel position-relative open-up"
    data-aos="zoom-out">
    <div class="container">
      <div class="d-flex flex-wrap justify-content-between align-items-center my-5 py-lg-5">
        <div class="line-img my-2">
  ...
  <section class="collection container ">
    <div
      ...
      <div class="col-md-5 column-container">
        <div class="cat-item position-relative">
          <div class="image-holder">
            <a href="shop.html"><img src="images/collection-banner.jpg" alt="categories"
                class="product-image img-fluid"></a>
  ...
  <section class="logo-bar mt-5">
    <div class="container">
      <div class="row mt-5 ">
        <div class="logo-content d-flex flex-wrap justify-content-between">
          <img src="images/logo1.png" alt="logo" class="logo-image img-fluid my-3">
          <img src="images/logo2.png" alt="logo" class="logo-image img-fluid my-3">
          <img src="images/logo3.png" alt="logo" class="logo-image img-fluid my-3">
          <img src="images/logo4.png" alt="logo" class="logo-image img-fluid my-3">
          <img src="images/logo5.png" alt="logo" class="logo-image img-fluid my-3">
        </div>
      </div>
    </div>
  </section>
