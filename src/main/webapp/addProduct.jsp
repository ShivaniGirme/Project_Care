...
<body class="homepage">
  ...
  <%
    ...
    %>
          ...
          <div>
          <img alt="myProduct" src="https://img.freepik.com/free-photo/3d-rendering-personal-care-products-fondant-pink_23-2151053863.jpg?size=626&ext=jpg&ga=GA1.1.553209589.1714262400&semt=ais" class="image">
          </div>
                ...
                <div class="user-details">
                    <div class="input-box" style="width: 500px;">
                        <span class="details">Product Name</span> <input type="text"
                            placeholder="Product_Name" id="pname" required name="name">
                    </div>
                    <div style="display: flex; width: 500px;">
                    
                        <div class="input-box" style="width: 250px;">
                        <span class="details">Description</span> <input type="text"
                            placeholder="Description" required name="discription">
                    </div>

                    <div class="input-box" style="margin-left: 20px;width: 250px;">
                        <span class="details">Product Quantity</span> <input type="text"
                            placeholder="Product_quantity" id="quantity" required
                            name="quantity">
                    </div>
                    </div>
                    <div style="display: flex; width: 500px;">
                        <div class="input-box" style="width: 250px;">
                        <span class="details">Mfg Date</span> <input type="date"
                            placeholder="Mfg_Date" id="mfgDate" required name="mgfDate">
                    </div>
                    <div class="input-box" style="margin-left: 20px;width: 250px;">
                        <span class="details">Exp Date</span> <input type="date"
                            placeholder="Exp_Date" id="expDate" required name="expDate">
                    </div>

                    </div>
                    <div class="input-box" style="width: 500px;">
                        <span class="details">Price</span> <input type="text"
                            placeholder="Price" id="price" required name="price">
                    </div>
                    <div class="input-box" style="width: 500px;">
                        <span class="details" >Upload Product Image</span> <input
                        type="file" name="file" required="required" style="width: 500px;"><br>
                    </div>
                    <div>
                        <label for="inputEmail4">Product Type : </label>
                    
                        <div>
                            <input type="radio" name="productType" value="skincare" required>
                        <label class="rdobtn">Skin care</label> <input type="radio"
                            name="productType" value="Haircare" required> <label
                            class="rdobtn">Hair Care</label> <input type="radio"
                            name="productType" value="Beautyproducts" required> <label
                            class="rdobtn">Beauty Products</label>
                        </div>
                    </div>
