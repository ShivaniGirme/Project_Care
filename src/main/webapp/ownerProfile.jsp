...
.frame {
	...
	background: #F6E7E5; /* Light pink */
  background: -webkit-linear-gradient(bottom left, #F6E7E5 0%, #EFD9D7 100%);
  background: -moz-linear-gradient(bottom left, #F6E7E5 0%, #EFD9D7 100%);
  background: -o-linear-gradient(bottom left, #F6E7E5 0%, #EFD9D7 100%);
  background: linear-gradient(to top right, #F6E7E5 0%, #EFD9D7 100%);
		...
		<div class="frame">
			<div class="center">
				...
				<div class="profile">
					...
					<div class="actions">
						<a href="ownerEditProfile.jsp"><button class="btn">Edit Profile</button></a>
					</div>
				</div>
